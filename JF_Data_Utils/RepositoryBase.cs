...
{
    public class RepositoryBase<TEntity> : ReadRepositoryBase<TEntity>, IRepositoryBase<TEntity> where TEntity : class
    {
        public RepositoryBase(JFContext context) : base(context)
        {
        }
